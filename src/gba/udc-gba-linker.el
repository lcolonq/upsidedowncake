...
(defun u/gba/initial-symtab ()
  ...
  (let ((symtab (u/gba/make-symtab :alignment 4)))
    ...
    (u/gba/symtab-add-entry! symtab :reg-dma0sad (u/gba/make-symtab-entry :addr #x040000b0 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma0dad (u/gba/make-symtab-entry :addr #x040000b4 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma0cnt (u/gba/make-symtab-entry :addr #x040000b8 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma1sad (u/gba/make-symtab-entry :addr #x040000bc :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma1dad (u/gba/make-symtab-entry :addr #x040000c0 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma1cnt (u/gba/make-symtab-entry :addr #x040000c4 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma2sad (u/gba/make-symtab-entry :addr #x040000c8 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma2dad (u/gba/make-symtab-entry :addr #x040000cc :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma2cnt (u/gba/make-symtab-entry :addr #x040000d0 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma3sad (u/gba/make-symtab-entry :addr #x040000d4 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma3dad (u/gba/make-symtab-entry :addr #x040000d8 :type 'var :data 4))
    (u/gba/symtab-add-entry! symtab :reg-dma3cnt (u/gba/make-symtab-entry :addr #x040000dc :type 'var :data 4))
