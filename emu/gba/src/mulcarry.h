...
bool tick_multiply(u32 multiplier, bool is_signed) {
  u32 mask = 0xffffff00;
  while (true) {
    multiplier &= mask;
...
bool multiply_carry_simple(u32 multiplier) {
...
bool multiply_carry_lo(u32 multiplicand, u32 multiplier, u32 accum) {
...
bool multiply_carry_hi(u32 multiplicand, u32 multiplier, u32 accum_hi, bool sign_extend) {
